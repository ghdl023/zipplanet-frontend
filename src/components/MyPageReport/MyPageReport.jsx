...
function MyPageReport() {
    ...
    return (
        <div className="report__container">
            {reviewList != '' ? <div className="report__header">총 {reviewList.length}개의 신고 내역이 있습니다.</div> : ''}
                        ...
                        <div className="report__item" key={index}>
                            ...
                            <div className="report__contents__box" >
                                ...
                                <table>
                                    <tr>
                                        <td>신고일</td>
                                        <td>{moment(review.reportDate).format('YYYY년MM월DD일')}</td>
                                    </tr>
                                    <tr>
                                        <td>처리상태</td>
                                        <td>{review.solveYn === 'N' ? '접수완료' : '처리완료'}</td>
                                    </tr>
                                </table>
                            </div>
                        </div>
